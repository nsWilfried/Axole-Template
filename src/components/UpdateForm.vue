<template>
    <div v-for="(post, index) in post" :key="index" style="width: 1320px;" class=" h-full bg-green- flex justify-content items-center ">
                ...
                <div class="w-1/2 h-full flex flex-col justify-center ">
                    ...
                    <div class="w-full p-4 bg-violet-">
                        <Field style="resize:none;" class="w-full h-24 p-2 text-gray-600  text-2xl" type="text"
                            placeholder="Entrez la description du post..." name="description" :value="post.description" />
