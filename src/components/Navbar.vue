<template>
    <div>
        ...
        <!-- navbar laptop -->
        <div
            class="  w-full  flex shadow-sm   justify-center items-center  lg:bg-white sm:bg-black sm:text-white navbar ">
            ...
            <div class="navbar__content flex">
                ...
                <div class="navbar__links w-full flex items-center justify-end">
                    ...
                    <div class=" flex flex-row" v-if="connected == false">
                        ...
                        <LinkButton name="s'inscrire" link='/user/register'
                            class="text-white bg-blue-400 font-bold  " />
                    </div>
        ...
        <!-- navbar mobile -->
        <div class="navbar__mobile shadow-md w-full bg--400 lg:bg-white sm:text-white">
            <div class=" h-16 grid grid-cols-2">

                <div class="navbar__brand bg-orange flex justify-center items-center">
                    <span class="navbar__brand__logo uppercase pl-6">
                        <router-link to="/"> Axole.</router-link>
                    </span>
                </div>

                <div class="w-full bg--400 flex items-center justify-end">
                    <Slide noOverlay right>
                        
                        <div class="navbar__mobile__link ">
                            <span>
                                <router-link to="/">Blog</router-link>
                            </span>
                        </div>
                        ...
                        <!-- login and register button -->
                        <div class=" flex flex-col" v-if="connected == false">
                            <LinkButton name='se connecter' link='/user/login' class="mb-4 text-black "
                                style='background: white;' />
                            <LinkButton name="s'inscrire" link='/user/register' class="text-white bg-blue-400 " />
                        </div>

                        <!-- create post button -->
                        <LinkButton v-if="connected == true" name='Créer un post' link='/create-post'
                            class="text-black " style='background: transparent;' />
